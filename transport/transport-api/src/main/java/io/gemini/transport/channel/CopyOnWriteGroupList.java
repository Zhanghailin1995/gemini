...
public class CopyOnWriteGroupList {
    ...
    private static final ChanGroup[] EMPTY_GROUP = new ChanGroup[0];
    private static final Object[] EMPTY_ARRAY = new Object[] { EMPTY_GROUP, null };

    private transient final ReentrantLock lock = new ReentrantLock();

    private final DirectoryChanGroup parent;

    // array[0]: ChanGroup[]
    // array[1]: Map<DirectoryString, WeightArray>
    private transient volatile Object[] array;

    public CopyOnWriteGroupList(DirectoryChanGroup parent) {
        this.parent = parent;
        setArray(EMPTY_ARRAY);
    }

    public final ChanGroup[] getSnapshot() {
        return tabAt0(array);
    }

    public final Object getWeightArray(ChanGroup[] snapshot, String directory) {
    ...
    public final boolean setWeightArray(ChanGroup[] snapshot, String directory, Object weightArray) {
    ...
    @SuppressWarnings("SameParameterValue")
    private void setArray(ChanGroup[] groups, Object weightArray) {
    ...
    public boolean contains(ChanGroup o) {
        ChanGroup[] elements = tabAt0(array);
        return indexOf(o, elements, 0, elements.length) >= 0;
    }

    public int indexOf(ChanGroup o) {
        ChanGroup[] elements = tabAt0(array);
        return indexOf(o, elements, 0, elements.length);
    }

    public int indexOf(ChanGroup o, int index) {
        ChanGroup[] elements = tabAt0(array);
        return indexOf(o, elements, index, elements.length);
    }

    public ChanGroup[] toArray() {
        ChanGroup[] elements = tabAt0(array);
        return Arrays.copyOf(elements, elements.length);
    }

    private ChanGroup get(ChanGroup[] array, int index) {
        return array[index];
    }

    public ChanGroup get(int index) {
     ...
     */
    public boolean remove(ChanGroup o) {
        ChanGroup[] snapshot = tabAt0(array);
        int index = indexOf(o, snapshot, 0, snapshot.length);
        return (index >= 0) && remove(o, snapshot, index);
    }

    /**
     * A version of remove(ChanGroup) using the strong hint that given
     * recent snapshot contains o at the given index.
     */
    private boolean remove(ChanGroup o, ChanGroup[] snapshot, int index) {
        final ReentrantLock lock = this.lock;
        lock.lock();
        try {
            ChanGroup[] current = tabAt0(array);
            ...
            ChanGroup[] newElements = new ChanGroup[len - 1];
     ...
     */
    public boolean addIfAbsent(ChanGroup o) {
        ChanGroup[] snapshot = tabAt0(array);
     ...
     */
    private boolean addIfAbsent(ChanGroup o, ChanGroup[] snapshot) {
        final ReentrantLock lock = this.lock;
        lock.lock();
        try {
            ChanGroup[] current = tabAt0(array);
            ...
            ChanGroup[] newElements = Arrays.copyOf(current, len + 1);
            newElements[len] = o;
            setArray(newElements, null);
    ...
    public boolean containsAll(Collection<? extends ChanGroup> c) {
        ChanGroup[] elements = tabAt0(array);
    ...
    public boolean equals(Object o) {
        ...
        ChanGroup[] elements = tabAt0(array);
        ChanGroup[] otherElements = tabAt0(other.array);
        int len = elements.length;
    ...
    public int hashCode() {
        ...
        for (int i = 0, len = elements.length; i < len; i++) {
            ChanGroup o = elements[i];
            hashCode = 31 * hashCode + (o == null ? 0 : o.hashCode());
        }
        return hashCode;
    }

    private boolean eq(ChanGroup o1, ChanGroup o2) {
        return (o1 == null ? o2 == null : o1.equals(o2));
    }

    private int indexOf(ChanGroup o, ChanGroup[] elements, int index, int fence) {
        if (o == null) {
    ...
    private static ChanGroup[] tabAt0(Object[] array) {
        return (ChanGroup[]) tabAt(array, 0);
    }
