...
public interface ProviderProcessor {
     ...
     * 处理正常请求
     */
    void handleRequest(Chan channel, RequestPayload request) throws Exception;

    /**
     * 处理异常
     */
    void handleException(Chan channel, RequestPayload request, Status status, Throwable cause);
