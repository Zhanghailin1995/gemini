 ...
 */
package io.gemini.transport.netty.handler.acceptor;
...
public class AcceptorHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (msg instanceof RequestPayload) {
            Chan chan = NettyChan.attachChannel(ch);
            try {
                processor.handleRequest(chan, (RequestPayload) msg);
            } catch (Throwable t) {
                processor.handleException(chan, (RequestPayload) msg, Status.SERVER_ERROR, t);
            }
        } else {
