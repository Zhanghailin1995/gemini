 ...
 * @author jiachun.fjc
 */
public class GeminiBadRequestException extends GeminiRemoteException {
    ...
    public GeminiBadRequestException(String message, Throwable cause) {
        super(message, cause);
    }

    public GeminiBadRequestException(Throwable cause) {
        super(cause);
    }
