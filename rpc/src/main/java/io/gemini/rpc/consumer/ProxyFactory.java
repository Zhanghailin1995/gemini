 ...
 */
package io.gemini.rpc.consumer;

import com.google.common.collect.Lists;
import io.gemini.common.contants.Constants;
import io.gemini.common.util.Proxies;
...
import io.gemini.rpc.InvokeType;
import io.gemini.rpc.ServiceProvider;
import io.gemini.rpc.consumer.cluster.ClusterInvoker;
import io.gemini.rpc.consumer.dispatcher.DefaultBroadcastDispatcher;
import io.gemini.rpc.consumer.dispatcher.DefaultRoundDispatcher;
import io.gemini.rpc.consumer.dispatcher.Dispatcher;
import io.gemini.rpc.consumer.invoker.AsyncInvoker;
import io.gemini.rpc.consumer.invoker.AutoInvoker;
import io.gemini.rpc.loadbalance.LoadBalancerFactory;
import io.gemini.rpc.loadbalance.LoadBalancerType;
...
public class ProxyFactory<I> {
    ...
    public I newProxyInstance() {
        ...
        ServiceMetadata metadata = new ServiceMetadata(
                group,
                providerName,
                Strings.isNotBlank(version) ? version : Constants.DEFAULT_VERSION
        );

        Connector<Connection> connector = client.connector();
