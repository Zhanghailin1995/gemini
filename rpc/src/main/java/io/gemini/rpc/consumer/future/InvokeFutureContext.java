...
/**
 * 异步调用上下文, 用于获取当前上下文中的 {@link InvokeFuture}, 基于 {@link FastThreadLocal}.
 *
 * jupiter
...
public class InvokeFutureContext {
    ...
    /**
     * 使用netty的FastThreadLocal
     */
    private static final FastThreadLocal<InvokeFuture<?>> futureThreadLocal = new FastThreadLocal<>();
