 ...
 *
 * gemini
 * io.gemini.rpc.loadbalance.NginxRoundRobinLoadBalancer
 *
 * @author zhanghailin
 */
public class NginxRoundRobinLoadBalancer implements LoadBalancer {


    @Override
    public ChanGroup select(CopyOnWriteGroupList groups, Directory directory) {
        return null;
    }
}
