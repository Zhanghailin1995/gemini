...
import io.gemini.transport.Acknowledge;
 ...
 * @author jiachun.fjc
 */
public final class DefaultRegistryServer extends AbstractNettyTcpAcceptor implements RegistryServer {
    ...
    private void handleOfflineNotice(RegisterMeta.Address address) {
        ...
        msg.messageCode(TransportProtocol.OFFLINE_NOTICE);
        msg.data(address);
    ...
    static class MessageDecoder extends ReplayingDecoder<MessageDecoder.State> {
        ...
        // 协议头
        private final TransportProtocol header = new TransportProtocol();
            ...
            switch (state()) {
                ...
                case BODY:
                    ...
                    switch (header.messageCode()) {
                        ...
                        case TransportProtocol.SUBSCRIBE_SERVICE:
            ...
            if (msg instanceof Message) {
                ...
                switch (obj.messageCode()) {
                    ...
                    case TransportProtocol.PUBLISH_CANCEL_SERVICE:
                        ...
                        if (obj.messageCode() == TransportProtocol.PUBLISH_SERVICE) {
                            handlePublish(meta, ch);
                        } else if (obj.messageCode() == TransportProtocol.PUBLISH_CANCEL_SERVICE) {
