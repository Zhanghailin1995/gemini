 ...
 * <p>
 * An {@link io.protostuff.runtime.IdStrategy} is standalone if the {@link #primaryGroup} is not set.
 *
 * @author Leo Romanoff
 * @author David Yu
 */
...
public abstract class IdStrategy {
    ...
    public final io.protostuff.runtime.IdStrategy primaryGroup;
    ...
    protected IdStrategy(int flags, io.protostuff.runtime.IdStrategy primaryGroup, int groupId) {
        ...
        DYNAMIC_VALUE_SCHEMA = new Schema<Object>() {
            ...
            public void mergeFrom(Input input, Object owner) throws IOException {
                if (PMapWrapper.class == owner.getClass()) {
                    ...
                    ((PMapWrapper) owner).setValue(ObjectSchema.readObjectFrom(
                            input, this, owner, io.protostuff.runtime.IdStrategy.this));
                } else {
            ...
            public void writeTo(Output output, Object message) throws IOException {
                ObjectSchema.writeObjectTo(output, message, this, io.protostuff.runtime.IdStrategy.this);
            }
        };
        ...
        DYNAMIC_VALUE_PIPE_SCHEMA = new Pipe.Schema<Object>(DYNAMIC_VALUE_SCHEMA) {
            ...
            protected void transfer(Pipe pipe, Input input, Output output)
                ...
                ObjectSchema.transferObject(this, pipe, input, output,
                        io.protostuff.runtime.IdStrategy.this);
            }
        };
        ...
        OBJECT_SCHEMA = new Schema<Object>() {
            ...
            public void mergeFrom(Input input, Object owner) throws IOException {
                ((Wrapper) owner).value = ObjectSchema.readObjectFrom(input, this,
                        owner, io.protostuff.runtime.IdStrategy.this);
            }
        ...
        CLASS_SCHEMA = new Schema<Object>() {
            ...
            @Override
            public void writeTo(Output output, Object message) throws IOException {
                ClassSchema.writeObjectTo(output, message, this, io.protostuff.runtime.IdStrategy.this);
            }
        };
        ...
        POLYMORPHIC_COLLECTION_SCHEMA = new Schema<Object>() {
            ...
            public void mergeFrom(Input input, Object owner) throws IOException {
                ((Wrapper) owner).value = PolymorphicCollectionSchema
                        .readObjectFrom(input, this, owner, io.protostuff.runtime.IdStrategy.this);
            }
        ...
        POLYMORPHIC_COLLECTION_PIPE_SCHEMA = new Pipe.Schema<Object>(POLYMORPHIC_COLLECTION_SCHEMA) {
            ...
            protected void transfer(Pipe pipe, Input input, Output output)
                ...
                PolymorphicCollectionSchema.transferObject(this, pipe, input,
                        output, io.protostuff.runtime.IdStrategy.this);
            }
        };
    ...
    /**
     * Responsible for instantiating custom {@link io.protostuff.runtime.IdStrategy} impls.
     */
    public interface Factory {
        /**
         * Creates a new {@link io.protostuff.runtime.IdStrategy} instance (impl).
         */
        io.protostuff.runtime.IdStrategy create();
